...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-btn-bg text-fg hover:bg-btn-hover border border-border dark:border-border",
        outline: "border border-border bg-btn-bg hover:bg-btn-hover",
        ghost: "hover:bg-btn-hover",
        danger: "bg-btn-danger text-white hover:bg-btn-danger-hover",
      },
      size: {
        default: "h-9 px-4 lg:h-10 lg:px-5",
        sm: "h-8 rounded-md px-3 text-xs lg:h-9 lg:px-4 lg:text-sm",
        lg: "h-11 rounded-md px-6 text-sm lg:h-12 lg:px-8 lg:text-base",
