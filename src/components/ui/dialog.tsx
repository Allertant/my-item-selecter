...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-3 top-3 rounded-md p-1.5 opacity-60 ring-offset-canvas transition-all hover:opacity-100 hover:bg-canvas-subtle focus:outline-none focus:ring-2 focus:ring-fg-muted focus:ring-offset-2 disabled:pointer-events-none cursor-pointer">
        <X className="h-4 w-4" />
